...
type StringUnion<S extends string> = S extends `${infer First}${infer Rest}`
    ? First | StringUnion<Rest>
    : S;
type AllCombinations<
    S extends string,
    SUnion extends string = StringUnion<S>,
    C extends string = SUnion,
> = C extends C ? `${C}${AllCombinations<"", Exclude<SUnion, C>>}` | "" : never;
