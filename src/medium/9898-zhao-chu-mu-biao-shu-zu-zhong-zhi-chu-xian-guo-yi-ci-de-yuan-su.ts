...
type Unique<T extends unknown[], U> = T extends [infer First, ...infer Rest]
...
> = T extends [infer First, ...infer Rest]
    ? Unique<Rest, First> extends true
        ? First extends Exists
            ? FindEles<Rest, Current, Exists>
            : FindEles<Rest, [...Current, First], Exists>
        : FindEles<Rest, Current, Exists | First>
    : Current;
