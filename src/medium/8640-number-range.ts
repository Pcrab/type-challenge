...
type NumberRange<
    ...
    NeedCount extends boolean = false,
    Ret extends number = never,
> = Current["length"] extends H
    ? H | Ret
    : NeedCount extends true
    ? NumberRange<L, H, [...Current, unknown], true, Current["length"] | Ret>
    : Current["length"] extends L
    ? NumberRange<L, H, [...Current, unknown], true, Current["length"] | Ret>
    : NumberRange<L, H, [...Current, unknown], NeedCount>;
