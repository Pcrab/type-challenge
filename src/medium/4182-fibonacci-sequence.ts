...
type Fibonacci<
    T extends number,
    CurrentCount extends unknown[] = [unknown, unknown, unknown],
    PrevOne extends unknown[] = [unknown],
    PrevTwo extends unknown[] = [unknown],
> = T extends 1 | 2
    ? 1
    : CurrentCount["length"] extends T
    ? [...PrevOne, ...PrevTwo]["length"]
    : Fibonacci<
          T,
